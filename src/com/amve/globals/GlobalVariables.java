...
//	public static final Integer DOWN_DIR = 5;
	...
	public static final Map<Integer, String> LETTER_TRANSLATIONS_REVERSE;
	static {
		LETTER_TRANSLATIONS_REVERSE = new HashMap<Integer, String>();
		
		LETTER_TRANSLATIONS_REVERSE.put(1, "A");
		LETTER_TRANSLATIONS_REVERSE.put(2, "B");
		LETTER_TRANSLATIONS_REVERSE.put(4, "C");
		LETTER_TRANSLATIONS_REVERSE.put(8, "D");
		LETTER_TRANSLATIONS_REVERSE.put(16, "E");
		LETTER_TRANSLATIONS_REVERSE.put(32, "F");
		LETTER_TRANSLATIONS_REVERSE.put(64, "G");
		LETTER_TRANSLATIONS_REVERSE.put(128, "H");
		LETTER_TRANSLATIONS_REVERSE.put(256, "I");
		LETTER_TRANSLATIONS_REVERSE.put(512, "J");
		LETTER_TRANSLATIONS_REVERSE.put(1024, "K");
		LETTER_TRANSLATIONS_REVERSE.put(2048, "L");
		LETTER_TRANSLATIONS_REVERSE.put(4096, "M");
		LETTER_TRANSLATIONS_REVERSE.put(8192, "N");
		LETTER_TRANSLATIONS_REVERSE.put(16384, "O");
		LETTER_TRANSLATIONS_REVERSE.put(32768, "P");
		LETTER_TRANSLATIONS_REVERSE.put(65536, "Q");
		LETTER_TRANSLATIONS_REVERSE.put(131072, "R");
		LETTER_TRANSLATIONS_REVERSE.put(262144, "S");
		LETTER_TRANSLATIONS_REVERSE.put(524288, "T");
		LETTER_TRANSLATIONS_REVERSE.put(1048576, "U");
		LETTER_TRANSLATIONS_REVERSE.put(2097152, "V");
		LETTER_TRANSLATIONS_REVERSE.put(4194304, "W");
		LETTER_TRANSLATIONS_REVERSE.put(8388608, "X");
		LETTER_TRANSLATIONS_REVERSE.put(16777216, "Y");
		LETTER_TRANSLATIONS_REVERSE.put(33554432, "Z");
		LETTER_TRANSLATIONS_REVERSE.put(67108864, "aa");
		LETTER_TRANSLATIONS_REVERSE.put(134217728, "bb");
		LETTER_TRANSLATIONS_REVERSE.put(268435456, "cc");
		LETTER_TRANSLATIONS_REVERSE.put(536870912, "dd");
		LETTER_TRANSLATIONS_REVERSE.put(1073741824, "ee");
	}
